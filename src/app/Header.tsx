...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-neutral-200/60 dark:border-white/10 bg-white/70 dark:bg-[#0b1020]/70 backdrop-blur supports-[backdrop-filter]:bg-white/50 dark:supports-[backdrop-filter]:bg-[#0b1020]/60">
